...
// Use f16 for better alignment with BF16 weights from HuggingFace
type Backend = LibTorch<f16>;
...
fn main() {
    ...
    let embeddings_values = embeddings_data.as_slice::<f16>().unwrap()
        .iter()
        .map(|&x| x as f32)
        .collect::<Vec<f32>>();
    ...
    let normed_values = normed_data.as_slice::<f16>().unwrap()
        .iter()
        .map(|&x| x as f32)
        .collect::<Vec<f32>>();
    ...
    let output_values = output_data.as_slice::<f16>().unwrap()
        .iter()
        .map(|&x| x as f32)
        .collect::<Vec<f32>>();
...
fn debug_mamba_forward_manual<B: Backend>(
    ...
    let proj_values = proj_data.as_slice::<f16>().unwrap()
        .iter()
        .map(|&x| x as f32)
        .collect::<Vec<f32>>();
    ...
    let conv_values = conv_data.as_slice::<f16>().unwrap()
        .iter()
        .map(|&x| x as f32)
        .collect::<Vec<f32>>();
    ...
    let gate_values = gate_data.as_slice::<f16>().unwrap()
        .iter()
        .map(|&x| x as f32)
        .collect::<Vec<f32>>();
    ...
    let dt_values = dt_data.as_slice::<f16>().unwrap()
        .iter()
        .map(|&x| x as f32)
        .collect::<Vec<f32>>();
    ...
    let conv_out_values = conv_out_data.as_slice::<f16>().unwrap()
        .iter()
        .map(|&x| x as f32)
        .collect::<Vec<f32>>();
    ...
    let x_act_values = x_act_data.as_slice::<f16>().unwrap()
        .iter()
        .map(|&x| x as f32)
        .collect::<Vec<f32>>();
    ...
    let delta_values = delta_data.as_slice::<f16>().unwrap()
        .iter()
        .map(|&x| x as f32)
        .collect::<Vec<f32>>();
    ...
    let x_norm_values = x_norm_data.as_slice::<f16>().unwrap()
        .iter()
        .map(|&x| x as f32)
        .collect::<Vec<f32>>();
